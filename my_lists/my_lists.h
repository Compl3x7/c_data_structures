...
Must be freed later with free_list()*/
List* new_list();
...
If used later with other functions, it should be stored in a variable of type List and passed as an argument to other function like "&<variable_name>"
